package com.neutroware.ebaysyncserver.ebay.api.getsellerevents;
...
public class GetSellerEvents {
    ...
    private static final String EBAY_API_CALL_NAME = "GetSellerEvents";
    ...
    public JsonNode getSellerEvents(String authToken, String startTimeFrom, String startTimeTo) throws Exception {
        String xmlResponse = sendGetSellerEventsRequest(authToken, startTimeFrom, startTimeTo);
        JsonNode jsonResponse = xmlMapper.readTree(xmlResponse);
        return jsonResponse;
    }

    private String sendGetSellerEventsRequest(String authToken, String startTimeFrom, String startTimeTo) throws Exception {
        String xmlRequest = buildXmlRequest(authToken, startTimeFrom, startTimeTo);
    ...
    private String buildXmlRequest(String authToken, String startTimeFrom, String startTimeTo) {
        return String.format(
                ...
                authToken, startTimeFrom, startTimeTo
        );
    }
}
